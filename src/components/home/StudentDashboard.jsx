...
export default function StudentDashboard() {
  ...
  return <main className="dashboard-page"><header className="dashboard-header"><a className="dashboard-brand" href="/"><span>A</span><strong>Bijak belajar</strong></a><div className="dashboard-actions"><a href="/murid" title="Tukar profil / Switch profile"><span className={`avatar avatar-small avatar-${avatar.color}`}><img src={avatar.image} alt="" onError={(event) => { event.currentTarget.hidden = true; }} /><span>{avatar.mark}</span></span><span>{profile.nickname}</span><UserRound size={16} /></a><a className="exit-link" href="/"><LogOut size={16} /><span>Keluar / Exit</span></a></div></header><section className="dashboard-content">
    ...
    <section className="dashboard-section subject-section"><div className="section-heading-row"><div><span className="section-kicker">Subjek / Subjects</span><h2>Pilih ruang belajar</h2></div></div><div className="dashboard-subject-grid"><a className="dashboard-subject subject-bm" href="/murid/bahasa-melayu"><img src={APP_IMAGES.bahasaMelayu3d} alt="" /><span><strong>Bahasa Melayu</strong><small>Malay</small></span><ArrowRight size={18} /></a><a className="dashboard-subject subject-math" href="/murid/matematik"><img src={APP_IMAGES.matematik3d} alt="" /><span><strong>Matematik</strong><small>Mathematics</small></span><ArrowRight size={18} /></a></div></section>
  </section></main>;
}
